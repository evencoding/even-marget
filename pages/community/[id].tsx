...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      ...
      <div className="mb-3 flex cursor-pointer items-center space-x-3 border-b p-3">
      ...
      <div className="px-4">
        ...
        />
        <button className="mt-2 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-1 focus:ring-orange-500 focus:ring-offset-2">
          Reply
        </button>
      </div>
    </div>
